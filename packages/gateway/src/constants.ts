...
export const TOPPAN_SERVICE_URL = env.TOPPAN_SERVICE_URL
export const TOPPAN_APP_URL = env.TOPPAN_APP_URL
export const CERTIFICATE_SERVICE_URL = env.CERTIFICATE_SERVICE_URL
export const GOID_SERVICE_URL = env.GOID_SERVICE_URL
