...
export const TOPPAN_DB_HOST = process.env.TOPPAN_DB_HOST || process.env.DB_HOST || 'toppan-postgres'
...
export const OPENSEARCH_HOST = process.env.OSHOST || process.env.OPENSEARCH_HOST || 'http://toppan-opensearch:9200'
